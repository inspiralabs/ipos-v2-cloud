...
export async function tenantLoyaltyRoutes(app: FastifyInstance) {
  ...
  app.get('/members', { preHandler: requireFeature(db, 'loyalty_program') }, async (request: any) => {
  ...
  app.post('/members', { preHandler: requireFeature(db, 'loyalty_program') }, async (request: any, reply) => {
  ...
  app.get('/members/lookup', { preHandler: requireFeature(db, 'loyalty_program') }, async (request: any, reply) => {
  ...
  app.post('/broadcasts', { preHandler: requireFeature(db, 'loyalty_program') }, async (request: any, reply) => {
  ...
  app.get('/broadcasts', { preHandler: requireFeature(db, 'loyalty_program') }, async (request: any) => {
    const { tenant_id } = request.user as { tenant_id: string };
