...
>(({ className, ...props }, ref) => (
  <AlertDialogPrimitive.Portal>
    ...
    <AlertDialogPrimitive.Content
      ref={ref}
      className={cn(
        'fixed inset-x-0 bottom-0 z-50 w-full rounded-t-2xl border border-[var(--border)] bg-[var(--surface)] p-6 sm:inset-x-auto sm:bottom-auto sm:left-1/2 sm:top-1/2 sm:max-w-sm sm:-translate-x-1/2 sm:-translate-y-1/2 sm:rounded-2xl',
        className
      )}
      {...props}
    />
...
>(({ className, ...props }, ref) => (
  <AlertDialogPrimitive.Title ref={ref} className={cn('text-lg font-bold text-[var(--ink)]', className)} {...props} />
));
